...
def adicionar_animal():
    ...
    print(f'{color_purple}O novo animal cadastrado é: \033[0m {pet} \n')
    animais.append(pet)
...
def exibir_todos_os_animais():
    print("Exibindo todos os animais...")

def buscar_animal_pelo_nome():
    print("Buscando animal pelo nome...")

def buscar_animais_do_dono():
    print("Buscando animais do dono...")
...
user_input = input("Digite algum comando: ")

comando = int(user_input)
if comando in comandos:
    comandos[comando]()
else:
    print("Não foi possivel realizar esse comando")
